from PySide6.QtWidgets import (QApplication, QWidget, QHBoxLayout,QLabel,
                               QVBoxLayout,QPushButton,QTreeView,QLineEdit,
                               QMainWindow, QMessageBox,QFileDialog,QCheckBox)
...
class FinanceApp(QMainWindow):
    ...
    def calc_interest(self):
        ...
        #update our chart with our data
        self.figure.clear()
    ...
    def save_data(self):
        ...
        if dir_path:
            ...
            QMessageBox.information(self, "Save results", "Results is saved to your folder")
