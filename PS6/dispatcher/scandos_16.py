...
from PySide6.QtWidgets import ( QApplication, QWidget, QVBoxLayout, QPushButton, QFileDialog,
    ...
    QToolBar,QGridLayout,QLineEdit
)
...
class LotViewer(QWidget):
    ...
    def __init__(self, lot_path, parent=None):
        ...
        frame1.setStyleSheet("border: 1px solid #cccccc; border-radius: 3px; padding: 5px;")
        frame1.setMaximumHeight(150)  # 🔹 environ 6 lignes de la table
        layout1 = QVBoxLayout()
        layout1.setSpacing(4)  # espace vertical réduit

        # Titre du cadre
        label_title = QLabel("Indexation pli en cours")
        label_title.setAlignment(Qt.AlignCenter)
        label_title.setStyleSheet("font-weight: bold; font-size: 10px; margin-bottom: 3px;")
        ...
        # Labels et insertion dans la grille
        labels = [
        ...
        frame2.setStyleSheet("border: 1px solid #cccccc; border-radius: 3px; padding: 5px;")
        layout2 = QVBoxLayout()
        ...
        frame3.setStyleSheet("border: 1px solid #cccccc; border-radius: 3px; padding: 5px;")
        layout3 = QVBoxLayout()
