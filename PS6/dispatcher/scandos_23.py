...
class LotsSummary(QWidget):
    ...
    def __init__(self):
        ...
        # Largeur des colonnes XML
        self.table.setColumnWidth(0, 180)
        self.table.setColumnWidth(1, 260)

        # Charge automatique si chemin dans config.ini
    ...
    # ---------------------------------------------------------
    # LECTURE DU PREMIER XML TYPE 1 POUR LES COLONNES AJOUTÉES
    # ---------------------------------------------------------
    def extract_type1_info(self, lot_dir):
        """Retourne (numaxa, service) à partir du XML type=1 du lot"""
        ...
        # Aucun XML type=1 trouvé → renvoyer vide
        return "", ""

    # ---------------------------------------------------------
    # LECTURE DE TOUS LES LOTS
    # ---------------------------------------------------------
    def load_summary(self, lots_dir):
        ...
        for subdir in sorted(os.listdir(lots_dir)):
            ...
            if os.path.isdir(subpath) and subdir.isdigit() and len(subdir) == 5:
                # Récupération données XML type 1
                ...
                for file in os.listdir(subpath):
                    ...
                    if file.lower().endswith(".jpg"):
                        ...
                        xml_type = self.get_xml_type(fpath)
                ...
                for col, val in enumerate(values):
                    ...
                    # Style spécial pour les colonnes XML
                    if col in (0, 1):
    ...
    # ---------------------------------------------------------
    # OUVERTURE DU LOT VIEWER (FENÊTRE 2)
    # ---------------------------------------------------------
    def open_lot_viewer(self, row, column):
        ...
        if os.path.exists(lot_path):
            from scandos_16 import LotViewer  # évite import circulaire
