...
class LotsSummary(QWidget):
    def __init__(self):
        ...
        self.table.setHorizontalHeaderLabels([
            ...
            "Nb XML Type 3", "Nb XML Type 4", "Nb Pages PDF"
        ])
    ...
    def load_summary(self, lots_dir):
        ...
        for subdir in sorted(os.listdir(lots_dir)):
            ...
            if os.path.isdir(subpath) and subdir.isdigit() and len(subdir) == 5:
                ...
                # Calcul du nombre de pages PDF (type 3 + type 4)
                nb_pages_pdf = xml_counts[3] + xml_counts[4]
                ...
                self.table.setItem(row, 6, QTableWidgetItem(str(nb_pages_pdf)))
