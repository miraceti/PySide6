from PySide6.QtWidgets import QWidget, QHBoxLayout,QTabWidget, QVBoxLayout,QTableWidget,QPushButton,QLabel,QLineEdit,QSpacerItem
...
class Widget(QWidget):
    def __init__(self):
        ...
        tab_widget.addTab(widget_buttons, "Boutons")
